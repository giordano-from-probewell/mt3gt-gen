...
#define SI5351C_XTAL        25000000               // Crystal oscillator frequency in kHz
#define SI5351C_PLL_FREQ    900000                  // Set PLL frequency to 900 MHz for simplicity
...
#define SI5351_MULTISYNTH_MIN_FREQ          500000            //1000000
...
typedef enum si5351c_status_en
{
    SI5351C_STATUS_CONFIG_ERROR         = -13,
    SI5351C_STATUS_INIT_ERROR           = -12,
    SI5351C_STATUS_INT_OFF_ERROR        = -11,
    SI5351C_STATUS_SEQ_WRITE_ERROR      = -10,
    SI5351C_STATUS_INT_READ_ERROR       = -9,
    SI5351C_STATUS_SYS_READ_ERROR       = -8,
    SI5351C_STATUS_CMD_STOP_ERROR       = -7,
    SI5351C_STATUS_CLK_ENA_ERROR        = -6,
    SI5351C_STATUS_OUTPUT_DIV_ERROR     = -5,
    SI5351C_STATUS_BAD_PLL_VALUE        = -4,
    SI5351C_STATUS_BAD_FREQ_VALUE       = -3,
    SI5351C_STATUS_WRITE_ERROR          = -2,
    SI5351C_STATUS_READ_ERROR           = -1,
    SI5351C_STATUS_OK                   = 0,
    SI5351C_STATUS_NOT_INITIALIZED      = 1,
} si5351c_status_t;
...
uint64_t multisynth_calc(uint32_t, struct Si5351RegSet *);
