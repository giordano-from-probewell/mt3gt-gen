...
#define _CMD_ANSWER         0xA003



int16_t cmd_set_voltage_waveform(uint8_t *error_category, uint8_t *error_code,uint16_t *command, uint8_t *data, uint16_t *size)
{
    ...
    for(i=0; i<data_size; i+=4)
    {
        ...
        //app.generation.voltage.ref.waveform1[j]=tmp.value;
        //app.generation.voltage.ref.waveform2[j]=tmp.value;
