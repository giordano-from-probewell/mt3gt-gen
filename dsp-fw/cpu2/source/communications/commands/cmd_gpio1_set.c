...
#define _CMD_ANSWER         0xB104



int16_t cmd_gpio1_set(uint8_t *error_category, uint8_t *error_code,uint16_t *command, uint8_t *data, uint16_t *size)
{
    uint16_t idx=0;
