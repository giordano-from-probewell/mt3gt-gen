...
#define _CMD_ANSWER         0xA001



int16_t cmd_reset_voltage_waveform(uint8_t *error_category, uint8_t *error_code,uint16_t *command, uint8_t *data, uint16_t *size)
{
...
//    for(i=0; i<1000; i++)
//    {
//        app.generation.voltage.ref.waveform1[i]=sinus[i];
//        app.generation.voltage.ref.waveform2[i]=sinus[i];
//    }
