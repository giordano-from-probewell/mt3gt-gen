...
#define _CMD_ANSWER         0x8000|0x5201

int16_t cmd_get_inst_measures(uint8_t *error_category, uint8_t *error_code,uint16_t *command, uint8_t *data, uint16_t *size)
{
...
//    //INSTANT METRICS
//    //VA
//    tmp.value = app.meter.phase[1].voltage.measures.rms;
...
//
//    //VB
//    tmp.value = app.meter.phase[2].voltage.measures.rms;
//    data[idx++] = tmp.byte.b3;
//    data[idx++] = tmp.byte.b2;
//    data[idx++] = tmp.byte.b1;
//    data[idx++] = tmp.byte.b0;
//
//    //VC
//    tmp.value = app.meter.phase[3].voltage.measures.rms;
//    data[idx++] = tmp.byte.b3;
//    data[idx++] = tmp.byte.b2;
//    data[idx++] = tmp.byte.b1;
//    data[idx++] = tmp.byte.b0;
//
//    //IA
//    tmp.value = app.meter.phase[1].current.measures.rms;
//    data[idx++] = tmp.byte.b3;
//    data[idx++] = tmp.byte.b2;
//    data[idx++] = tmp.byte.b1;
//    data[idx++] = tmp.byte.b0;
//
//    //IB
//    tmp.value = app.meter.phase[2].current.measures.rms;
//    data[idx++] = tmp.byte.b3;
//    data[idx++] = tmp.byte.b2;
//    data[idx++] = tmp.byte.b1;
//    data[idx++] = tmp.byte.b0;
//
//    //IC
//    tmp.value = app.meter.phase[3].current.measures.rms;
//    data[idx++] = tmp.byte.b3;
//    data[idx++] = tmp.byte.b2;
//    data[idx++] = tmp.byte.b1;
//    data[idx++] = tmp.byte.b0;
