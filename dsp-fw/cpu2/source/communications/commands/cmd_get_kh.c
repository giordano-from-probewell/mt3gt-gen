...
#define _CMD_ANSWER_AMOUNT  (4)

#define _CMD_ANSWER         0x5002

int16_t cmd_get_kh(uint8_t *error_category, uint8_t *error_code,uint16_t *command, uint8_t *data, uint16_t *size)
{
