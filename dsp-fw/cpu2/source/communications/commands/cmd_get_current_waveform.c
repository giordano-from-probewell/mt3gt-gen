...
#define _CMD_ANSWER         0xA00A

int16_t cmd_get_current_waveform(uint8_t *error_category, uint8_t *error_code,uint16_t *command, uint8_t *data, uint16_t *size)
{
    uint16_t i=0;
...
//    for(i=0; i<1000; i++)
//    {
//        float32_to_uint8_t(data+(4*i), app.generation.current.ref.waveform1[i]);
//    }
