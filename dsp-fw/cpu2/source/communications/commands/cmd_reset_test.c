...
#define _CMD_ANSWER         0x8000|0x5101

int16_t cmd_reset_test(uint8_t *error_category, uint8_t *error_code,uint16_t *command, uint8_t *data, uint16_t *size)
{
    ...
    int8_t x=0;
    ipc_enqueue_to_cpu1(IPC_CMD_RESET_TEST, &x, 1);
