...
PAGE 0 :  /* Program Memory */
   ...
   FLASH_CPU1       : origin = 0x082000, length = 0x006000	/* on-chip Flash */
   //FLASHB         : origin = 0x082000, length = 0x002000	/* on-chip Flash */
   //FLASHC         : origin = 0x084000, length = 0x002000	/* on-chip Flash */
   //FLASHD         : origin = 0x086000, length = 0x002000	/* on-chip Flash */
   FLASH_TEXT1      : origin = 0x088000, length = 0x010000	/* on-chip Flash */
...
//// CPU  INIT ////
   	...
   	.text               :> FLASH_TEXT1,    						PAGE = 0, ALIGN(8)
   	.cinit              :> FLASH_CPU1,     						PAGE = 0, ALIGN(8)
   	.pinit              :> FLASH_CPU1,     						PAGE = 0, ALIGN(8)
   	...
   	.econst             :> FLASH_CPU1,  	    				PAGE = 0, ALIGN(8)
   	.switch             :> FLASH_CPU1,   	   					PAGE = 0, ALIGN(8)
   	.reset              :> RESET,     							PAGE = 0, TYPE = DSECT /* not used, */

    FPUmathTables 		:> FLASHN, 			        			PAGE = 0
	dclfuncs 			:> RAMGS_CPU1, 							PAGE = 1
    ...
    .farconst           :> SDRAM_CPU1,                          PAGE = 1, ALIGN(4)  /* Far memory constants */
